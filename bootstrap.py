"""
Composition Root : le SEUL fichier qui connaît à la fois les interfaces
(core/ports/) et les implémentations concrètes (llm/, resources/, utils/).
Construit tous les objets une fois, au démarrage, et les assemble.
"""
...
def build_container() -> Container:
    """Assemble toute la chaîne de dépendances (injection de dépendances manuelle)."""
